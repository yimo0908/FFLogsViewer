...
public class Configuration : IPluginConfiguration
{
    ...
    private static List<LayoutEntry> GetDefaultLayout()
    {
        ...
        [
            ...
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝巴哈", Expansion = "Dawntrail", Zone = "Ultimates (Legacy)", ZoneId = 59, Encounter = "The Unending Coil of Bahamut", EncounterId = 1073, Difficulty = "Normal", DifficultyId = 100, Alias = "UCoB", SwapId = "DT ult", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝神兵", Expansion = "Dawntrail", Zone = "Ultimates (Legacy)", ZoneId = 59, Encounter = "The Weapon's Refrain", EncounterId = 1074, Difficulty = "Normal", DifficultyId = 100, Alias = "UwU", SwapId = "DT ult", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝亚", Expansion = "Dawntrail", Zone = "Ultimates (Legacy)", ZoneId = 59, Encounter = "The Epic of Alexander", EncounterId = 1075, Difficulty = "Normal", DifficultyId = 100, Alias = "TEA", SwapId = "DT ult", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝龙诗", Expansion = "Dawntrail", Zone = "Ultimates (Legacy)", ZoneId = 59, Encounter = "Dragonsong's Reprise", EncounterId = 1076, Difficulty = "Normal", DifficultyId = 100, Alias = "DSR", SwapId = "DT ult", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝欧", Expansion = "Dawntrail", Zone = "Ultimates (Legacy)", ZoneId = 59, Encounter = "The Omega Protocol", EncounterId = 1077, Difficulty = "Normal", DifficultyId = 100, Alias = "TOP", SwapId = "DT ult", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝伊甸", Expansion = "Dawntrail", Zone = "Futures Rewritten", ZoneId = 65, Encounter = "Futures Rewritten", EncounterId = 1079, Difficulty = "Normal", DifficultyId = 100, Alias = "FRU", SwapId = "DT ult", SwapNumber = 0 },
            new LayoutEntry { Type = LayoutEntryType.Header, Alias = "绝本 (EW)", Expansion = "-", Zone = "-", Encounter = "-", Difficulty = "-", SwapId = "DT ult", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝巴哈", Expansion = "Endwalker", Zone = "Ultimates (Legacy)", ZoneId = 43, Encounter = "The Unending Coil of Bahamut", EncounterId = 1060, Difficulty = "Normal", DifficultyId = 100, Alias = "UCoB", SwapId = "DT ult", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝神兵", Expansion = "Endwalker", Zone = "Ultimates (Legacy)", ZoneId = 43, Encounter = "The Weapon's Refrain", EncounterId = 1061, Difficulty = "Normal", DifficultyId = 100, Alias = "UwU", SwapId = "DT ult", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝亚", Expansion = "Endwalker", Zone = "Ultimates (Legacy)", ZoneId = 43, Encounter = "The Epic of Alexander", EncounterId = 1062, Difficulty = "Normal", DifficultyId = 100, Alias = "TEA", SwapId = "DT ult", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝龙诗", Expansion = "Endwalker", Zone = "Dragonsong's Reprise", ZoneId = 45, Encounter = "Dragonsong's Reprise", EncounterId = 1065, Difficulty = "Normal", DifficultyId = 100, Alias = "DSR", SwapId = "DT ult", SwapNumber = 1 },
            new LayoutEntry { Type = LayoutEntryType.Encounter, Alias = "绝欧", Expansion = "Endwalker", Zone = "The Omega Protocol", ZoneId = 53, Encounter = "The Omega Protocol", EncounterId = 1068, Difficulty = "Normal", DifficultyId = 100, Alias = "TOP", SwapId = "DT ult", SwapNumber = 1 },
